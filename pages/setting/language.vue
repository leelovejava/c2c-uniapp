<template>
	<view class="language_page">
		<u-navbar :title="common.language" background="#333230" back-icon-color="#fff" title-color="#fff"></u-navbar>
		<view class="list">
			<view class="items" v-for="item in langs" :key="item.value" @tap="setLangyanBtn(item)">
				<text>{{ item.name }}</text>
