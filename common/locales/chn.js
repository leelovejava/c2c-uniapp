...
export default {
	common: {
		...
		hall: {
			default: ["交易大厅", "余额", "我要买", "我要卖", "确认卖出", "订单列表", "卖出订单", "卖给商家", "挂单中", "买入", "出售"],
	...
	faqs: {
		...
		basicRules: {
			...
			'rules': [
				...
				"4：超过一定的存款金额的账号VIP将会自动升级。",
				"5：平台是在Web3中运行，面向全世界用户任何时间都可以自由的进行兑换。",
				"6：为了你的账户安全起见请不要泄露你的助记词。",
				"7：信用分数会在每日太平洋时间00：00分更新信用分数低于95分是你的账户会被冻结提现功能，为了账号安全需要联系客服人员解决。",
				"8：提款注意事项，请根据规定填写正确的银行信息因为提款是存在国际电汇到账时间正常1-5个工作日，填写错误的信息会导致电汇失败需要等待资金撤回后在次提取，错误会导致你的信誉值有所下降。",
				"9：平台运行在Web3,现目前与Trust签署了信任运行许可证，基于其他Web3不影响登录。"
			]
		},
		platformOperation: {
			title: "平台运营",
		...
		orderTypes: {
			...
			marketOrder: {
				title: "Market Order",
				description: "外汇平台用户接受当前市场最佳可用汇率并立即完成兑换。系统会定时更新收购商发布的订单事实汇率，用户根据自己的可用余额自行选择订单。"
			},
			limitOrder: {
				title: "Limit Order",
		...
		giftPackage: {
			title: "Gift Package",
			description: [
				"礼品包是为我们尊贵的VIP会员提供专属的优惠。每提高一级VIP都将获得一份固定奖励作为奖励，这份奖励你可以自由的支配没有任何的限制。"
			]
		},
		deposits: {
			title: "Deposits",
